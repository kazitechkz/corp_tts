<nav id="sidebar">
    <div class="p-4 pt-5">
        <a  href="{{route('cto-employee-profile')}}" class="img logo rounded-circle mb-5" style="background-image: url({{auth()->user()->img}});"></a>
        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <li>
                <a href="{{route('techSupportEmployeeHome')}}"  class="{{request()->routeIs('techSupportEmployeeHome') ? 'waves-effect-active' : 'waves-effect'}}">
                    <div class="d-inline-block icons-sm mr-1"><i class="fas fa-ticket-alt"></i></div>
                    <span>Тикеты</span>
                </a>
            </li>
            <hr>
