            ...
            <div class="page-title-box">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 class="page-title mb-1">Список категорий форумов</h4>
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="/admin">Главная</a></li>
                                <li class="breadcrumb-item active">Список категорий литературы</li>
                            </ol>
                        </div>
                        <div class="col-md-4">
                            <div class="float-right d-none d-md-block">
                                <div class="dropdown">
                                    <a href="{{route("forum-category.create")}}" class="btn btn-light btn-rounded dropdown-toggle">
                                ...
                                <div class="card h-full shadow-lg">
                                    <section class="py-2 px-3 border-t-[20px] border-warning border-tr-xl border-tl-xl rounded-lg">
                                        ...
                                        <div class="flex justify-content-between">
                                            <a href="{{route("forum-category.edit",$category->id)}}" class="btn btn-warning text-white">
                                                <i class="fas fa-pen-alt"></i>
                                            </a>
                                            <form action="{{route('forum-category.destroy',$category->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
