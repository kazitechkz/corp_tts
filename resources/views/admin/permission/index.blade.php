            ...
            <div class="page-title-box">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 class="page-title mb-1">Список разрешений</h4>
                        ...
                        <div class="col-md-4">
                            <div class="float-right d-none d-md-block">
                                <div class="dropdown">
                                    <a href="{{route("permission.create")}}" class="btn btn-light btn-rounded dropdown-toggle">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($permissions as $permission)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex">
                                                    <a href="{{route("permission.edit",$permission->id)}}" class="btn btn-warning text-white mx-2">
