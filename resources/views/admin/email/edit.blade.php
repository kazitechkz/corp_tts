                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form id="js-form" action="{{route("email.update",$email->id)}}" method="post">
                                        @method("PUT")
                                        @csrf
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-md-2 col-form-label">Почта</label>
                                            <div class="col-md-10">
                                                <input class="form-control  @error('email') is-invalid @enderror" name="email" type="email" value="{{$email->email}}" id="example-text-input">
                                            </div>
                                        </div>
