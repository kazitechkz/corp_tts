<div class="row my-2 py-4">
    ...
    <div class="col-12 bg-white shadow-lg rounded-lg p-3">
        <form id="js-form" action="{{route("employee-schedule.update",$schedule->id)}}" method="post" enctype="multipart/form-data">
            @method('PUT')
    ...
    <div class="col-12 bg-white shadow-lg rounded-lg p-3">
        <form action="{{route("employee-schedule.destroy",$schedule->id)}}" method="post">
            @method('DELETE')
