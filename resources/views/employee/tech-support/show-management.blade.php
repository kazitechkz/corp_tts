...
@section('content')
    ...
    <div>
        ...
        <div class="page-content">
            <div class="container mb-5">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-3 my-2 text-right">
                        <a href="{{route("employee-ticket.index")}}" class="btn btn-warning text-white">
                        ...
                        <a class="block p-3 bg-white border border-gray-200 rounded-lg shadow">
                            ...
                            @if(!$ticket->is_resolved)
                                <div class="md:flex justify-content-end">
                                    <form id="closeTicketForm" action="{{route("employee-ticket.update",$ticket->id)}}" method="post">
                                        @csrf
                                        @method('PATCH')
            ...
            <livewire:employee.ticket.management-show :ticket="$ticket"/>
