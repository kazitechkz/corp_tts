                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{route('userUpdateProfile')}}" method="post" id="js-form" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="modal-footer">
                                            <a href="{{route('techSupportEmployeeHome')}}" class="btn btn-secondary waves-effect">Назад</a>
